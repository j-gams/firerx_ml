...
commandstr='"cd ~/'${instdir}'; nohup ~/anaconda3/bin/python align_raster.py core_aws=false core_aw2=true locl_ras=../'${instdir}'/ locl_tro=./geotifs_raw locl_rjo=geotifs_raw/ locl_clp=aligned_out skip_trm=true skip_rrj=true skip_erj=true skip_res=true skip_raw=true pram_sub='${assignstr}' > ~/align_log.txt"'
...
echo "evaluating commands string 2"
eval "$commandstr2"
